...
<section class="site-wrapper">
        ...
        <div class="row">
          <div class="col-xs-12 col-lg-offset-1 col-lg-10">
            <div class="page-title text-center">
              <h2>Awesome <span class="primary">Services</span> <span class="title-bg">Loans</span></h2>
  ...
  <div class="container">
    <div class="flex flex-middle space-between">
      <span class="prev-page"><a href="expenditure.php" class="link">&larr; Prev Page</a></span>
        <span class="copyright">Copyright &copy; <span id="year"></span>, Designed &amp; Developed by <a href="https://themefisher.com/">Themefisher</a>.</span>
      <span class="next-page"><a href="income.php" class="link">Next Page &rarr;</a></span>
    </div>
  </div>
  <!-- /.page-nav -->
</nav>
